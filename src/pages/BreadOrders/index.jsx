    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Manage bread orders and deliveries</p>
        </div>
      ...
      <div className="card">
        ...
        <div className="empty-state">
          ...
          <p className="empty-state-text">No bread orders yet</p>
          <p className="empty-state-subtext">Start by creating your first bread order</p>
